...
export default class CategoryComponentsPage extends AlertPage {
...
export class CategoryDeleteDialog {
  ...
  title: ElementFinder = element(by.id('newsApp.category.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-category'));
}
