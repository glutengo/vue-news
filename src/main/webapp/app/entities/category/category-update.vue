  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="newsApp.category.home.createOrEditLabel"
          data-cy="CategoryCreateUpdateHeading"
          v-text="$t('newsApp.category.home.createOrEditLabel')"
        >
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('newsApp.category.name')" for="category-name">Name</label>
            <input
              type="text"
              class="form-control"
              name="name"
